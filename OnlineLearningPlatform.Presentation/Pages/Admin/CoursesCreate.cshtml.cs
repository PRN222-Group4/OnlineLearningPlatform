...
namespace OnlineLearningPlatform.Presentation.Pages.Admin
{
    ...
    {
        private readonly ICourseService _service;
        public CoursesCreateModel(ICourseService service) => _service = service;

        [BindProperty]
        public CreateNewCourseRequest Request { get; set; } = new();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                TempData["Toast"] = "Course created successfully.";
